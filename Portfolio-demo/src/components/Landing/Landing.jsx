        ...
        >
          <div className="lcl--content">
            {socialsData.linkedIn && (
              <a
                href="https://www.linkedin.com/in/coderaadi/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin
            ...
            {socialsData.github && (
              <a
                href="https://github.com/Aditya23489e"
                target="_blank"
                rel="noreferrer"
              >
                <FaGithub
            ...
            >
              <div style={{ marginBottom: "30px" }}>
                {headerData.resumePdf && (
                  <a
                    href="https://drive.google.com/file/d/1ZJexTO1RE8KococKoLD6St5Vu-G683Lw/view?usp=sharing"
                    download="resume"
                    target="_blank"
                    rel="noreferrer"
                  >
